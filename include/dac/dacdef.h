...
namespace	PDT
{
	...
	enum	CHANNEL_TYPE
	{
		...
		CHANNEL_TYPE_MULTICASTUDP		=	5,			//组播UDP
		CHANNEL_TYPE_GATESERVER =   6,			//网关服务端
		CHANNEL_TYPE_GATE3761 =   7,			//376.1网关
		CHANNEL_TYPE_SERIALWIRELESS = 8,		//无线串口
	...
	enum	YK_ACTION				//遥控动作类型
	{
		YK_ACTION_SELECT				=	0,
		YK_ACTION_SELECT_V				=	1,
		YK_ACTION_EXECUTE				=	2,
		YK_ACTION_CANCEL				=	3
	};
