...
namespace nsFTP
{
   ...
   /// Data Structure
   class FTPCLIENT_DLL_PORT CStructure
   {
   public:
   ...
   /// Transmission Modes
   class FTPCLIENT_DLL_PORT CTransferMode
   {
   public:
   ...
   /// Firewall Type
   class FTPCLIENT_DLL_PORT CFirewallType
   {
   public:
   ...
   class FTPCLIENT_DLL_PORT CType
   {
   public:
   ...
   class FTPCLIENT_DLL_PORT CTypeFormat
   {
   public:
   ...
   class FTPCLIENT_DLL_PORT CRepresentation
   {
   public:
   ...
   class FTPCLIENT_DLL_PORT CDatachannelCmd
   {
   public:
   ...
   class FTPCLIENT_DLL_PORT CLogonInfo
   {
   public:
      CLogonInfo();
   ...
   class FTPCLIENT_DLL_PORT CReply
   {
