...
void	CShareMemory::map()
{
	...
	size_t	ycSize = DAC_SHM_HEAD_SIZE + sizeof(DAC_SHM_YC) + DAC_ROUTE_NUM *(DAC_SHM_HEAD_SIZE + DAC_YC_NUM * sizeof(DAC_YC) + DAC_YC_NUM * sizeof(DAC_YC_DATA) + 2 * DAC_YC_NUM * sizeof( DAC_YC_CHG_DATA));
		//DAC_SHM_HEAD_SIZE + sizeof(DAC_SHM_YC) + DAC_ROUTE_NUM * (DAC_SHM_HEAD_SIZE + 2 * DAC_YC_NUM * (sizeof(DAC_YC_DATA)+sizeof(DAC_YC_CHG_DATA)));
	size_t	yxSize = DAC_SHM_HEAD_SIZE + sizeof(DAC_SHM_YX) + DAC_ROUTE_NUM *(DAC_SHM_HEAD_SIZE + DAC_YX_NUM * sizeof(DAC_YX) + DAC_YX_NUM * sizeof(DAC_YX_DATA) + 2 * DAC_YX_NUM * sizeof( DAC_YX_CHG_DATA));
		//DAC_SHM_HEAD_SIZE + sizeof(DAC_SHM_YX) + DAC_ROUTE_NUM * (DAC_SHM_HEAD_SIZE + 2 * DAC_YX_NUM * (sizeof(DAC_YX_DATA)+sizeof(DAC_YX_CHG_DATA)));
